...
const qaItems = [
  {
    ...
    a: "オカムラの展示会やオフィスで短期間利用し廃棄予定のものを特別ルートでリユースしているため、スタートアップが利用できる価格になっております。",
  },
  {
    q: "サブスク利用後に、買取することは可能ですか？",
    a: "可能です。サブスクの利用期間によって買取価格もお安くなります。",
  },
  {
    q: "運搬・施工に費用はかかりますか？",
    a: "オフィス入居時は無料です。オフィス入居後に家具を追加する場合、別途配送、組み立て費用をいただく場合がございます。上記の家具ホーダイのサービスサイトから、各製品の配送・組み立て費用が確認できます。",
  },
];
