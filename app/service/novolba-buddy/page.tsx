  ...
  return (
    <main className="bg-white">
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-xl font-bold text-center text-gray-800 mb-10">
            ノボルバディ〜ステージに合わせたパターン〜
          </h2>

          {/* シード期 */}
          <div className="rounded-2xl border-2 p-6 mb-6 bg-white" style={{ borderColor: "#3dbdac" }}>
              ...
              {seedSteps.map((step, i) => (
                <div key={step.label} className="flex items-center gap-2">
                  <div className="flex flex-col items-center">
                    <div
                      className="px-3 py-2 rounded-lg text-xs font-semibold text-white text-center"
                      style={{ backgroundColor: "#3dbdac" }}
                    >
                      {step.label}
                    </div>
                    {step.note && (
                      <span className="text-xs text-gray-400 mt-1">{step.note}</span>
                    )}
                  </div>
                  {i < seedSteps.length - 1 && (
          ...
          {/* アーリー期以降 */}
          <div className="rounded-2xl border-2 p-6 bg-white" style={{ borderColor: "#3dbdac" }}>
            <div className="flex items-center gap-3 mb-4">
              <span
                className="px-3 py-1 rounded-full text-sm font-bold text-white"
                style={{ backgroundColor: "#3dbdac" }}
